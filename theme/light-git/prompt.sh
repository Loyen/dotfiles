...
GIT_SYM_BRANCH="${Red}"
GIT_SYM_CLEAN="${Green}OK"
GIT_SYM_CHANGED="${Green}CHANGED "
GIT_SYM_CONFLICTS="${Red}CONFLICTS "
GIT_SYM_STAGED="${Yellow}STAGED "
GIT_SYM_UNTRACKED="${Blue}ADDED "
GIT_SYM_DELETED="${Red}DELETED "
GIT_SYM_STASHED="${Yellow}STASHED "
